...
class DetailPage2_KM extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('2번 $date',style: TextStyle(
            color: Colors.black),),
        leading: IconButton(
          onPressed: (){
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('KM_wire_2/dates/$date').snapshots(),
