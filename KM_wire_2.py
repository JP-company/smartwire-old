...
def firststop(): #첫 멈춤
    ...
    if start_reader() != True and nowire_reader() == True: # 와이어 선 부족
    ...
    elif start_reader() != True and nowire_reader() != True and finished_reader() != True and comoff_reader() != True and contact_reader() != True and moff_reader() != True: # 와이어 줄 연결 실패
